...
public class Extentlogger extends BaseClass {
	...
	public Extentlogger(AndroidDriver driver) {
		super();
	 ...
	 * ExtentManager.getExtentTest().pass(message); log.info(message);
	 * 
	 * }
	 */
	...
	public static void pass(String message) {
		...
		if (test != null) {
			...
			log.error("ExtentTest is not initialized. Call ExtentManager.createTest() before logging.");
		}
	}
